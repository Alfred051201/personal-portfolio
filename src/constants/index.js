import {
  ...
  const projects = [
    {
      name: "E-commerce",
      description: "An e-commerce website that allows users to search and purchase products",
      tags: [
        {
          name: "react",
  ...
  export { technologies, experiences, projects, testimonials};